    ...
    <?php else: ?>
                        ...
                        <form method="post" value="/register">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="name" value="<?php echo $name;?>" placeholder="Имя">                                        
                                    </div>
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                        <button name="submit" type="submit" class="btn btn-success btn-block">Зарегестрироватся</button>
